...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		@if(!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
			<div class="bg-light-blue-active text-right font-13 padding-2">
	...
	<div class="col-md-6 invoice-col width-50 ">
		...
		@if(!empty($receipt_details->logo))
			<img style="max-height: 50px; width: auto;" src="{{$receipt_details->logo}}" class="img center-block">
			<br/>
		@endif
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #357ca5 !important; color: white !important" class="font-15">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-15" style="background-color: #357ca5 !important; color: white !important">
