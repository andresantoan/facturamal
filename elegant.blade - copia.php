...
<table style="width:100%;">
	...
	<div class="col-md-6 invoice-col">
		...
		@if(!empty($receipt_details->logo))
			<img style="max-height: auto; width: 100px;" src="{{$receipt_details->logo}}" class="img">
...
<div class="col-xs-12">
	...
	<div class="col-md-6  invoice-col width-50">
		...
		<b class="pull-left"><br>{{__('lang_v1.authorized_signatory')}}</b>
		<b class="pull-right"><br>Entrego</b>
	</div>
...
@endif
	...
	<div class="row">
		...
		<div class="@if($receipt_details->show_barcode) col-xs-8 @else col-xs-12 @endif">
